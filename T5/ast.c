...
void astPrint(Ast *node, int nivel)
{
	...
	if(node != 0)
	{
		...
		switch(node->type)
		{
			...
			case 24: printf("AST_DIF\n"); break;
			case 25: printf("AST_RANGE\n"); break;
			case 26: printf("AST_RETURN\n"); break;
			case 27: printf("AST_READ\n"); break;
			case 28: printf("AST_UNTIL\n"); break;
			case 29: printf("AST_COMEFROM\n"); break;
			case 30: printf("AST_BODY\n"); break;
			case 31: printf("AST_LISTCMD\n"); break;
			case 32: printf("AST_PRINT\n"); break;
			case 33: printf("AST_PRINTLIST\n"); break;
			case 34: printf("AST_PARAM\n"); break;
			case 35: printf("AST_DATA\n"); break;
			case 36: printf("AST_INT\n"); break;
			case 37: printf("AST_FLOAT\n"); break;
			case 38: printf("AST_CHAR\n"); break;
			case 39: printf("AST_LISTPARAM\n"); break;
			case 40: printf("AST_HEADER\n"); break;
			case 41: printf("AST_VARIAVEL_DEC\n"); break;
			case 42: printf("AST_VEC_DEC\n"); break;
			case 43: printf("AST_LISTLIT\n"); break;
			case 44: printf("AST_VEC_DEC_INIT\n"); break;
			case 45: printf("AST_LISTDEC\n"); break;
			case 46: printf("AST_LISTFUN\n"); break;
			case 47: printf("AST_TOP\n"); break;
		}
